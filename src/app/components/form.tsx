...
import { SchoolSubjectEnum, StudyProgramEnum } from '@/app/types';
import { useFormState, useFormStatus } from "react-dom";
import { submitRegistration, State } from "@/app/actions/registration-action";
...
export function Form() {
  ...
  const [state, formAction] = useFormState<State, FormData>(submitRegistration, null);
